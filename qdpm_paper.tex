...
\end{equation}
and the gauge symmetry is now reduced from $U(1)$ to $Z_2$. The set of allowed dimer resonances $\mathcal{C}_{\rm{TC}}$ is expanded accordingly \textcolor{red}{Owen: Add symbols for 4-0 resonance, and 1-3 resonances and 2-2 resonance}:
\begin{align}
...
\end{equation}
such that $\HTC$ takes the form of \Eqref{eq:HRK} (up to a constant), and the RK state is the ground state for all values of $t$.
...
\section{Spacial Dimer Correlation Results}
    ...
    \begin{equation}
        ...
        ,
    \end{equation}
    where $d_i$ represents the presence of a dimer on link i, $1/2$ or $-1/2$ for the presence or
    absence of a dimer respectively.
    ...
    we find no evidence of broken symmetries for system sizes up to $32\times32$. As an example of the
    absence of broken symmetries we show
    the dimer correlation function measured between a single dimer and all other dimers on the
    ...
    \begin{figure}[htpb]
        ...
        \caption{Gray scale (actual data) of the dimer correlation between the dimer in the upper
    ...
    The dimer correlations decay exponentially in the distance between the dimers. 
    ...
    %\begin{figure}[htpb]
    %    \centering
    %    \includegraphics[width=0.8\linewidth]{spacial_z3vis_cor.pdf}
    %    \caption{The $Z_3$ vison correlation function for $\gamma=0.5$.}
    %    \label{fig:spacial_z3vis_cor}
    %\end{figure}

    \begin{figure}[htpb]
        \centering
        \includegraphics[width=1.0\linewidth]{qdpm_dmr_HM_16x16.pdf}
    ...
    \begin{figure}[htpb]
        \centering
        \includegraphics[width=1.0\linewidth]{qdpm_vis_HM_16x16.pdf}
    ...
    \begin{figure}[htpb]
        \centering
        \includegraphics[width=1.0\linewidth]{vis_dmr_qdpm_struc_fac_16x16.pdf}
