...
\begin{figure}[]
    \centering
    \includegraphics[width=0.5\columnwidth]{example_mag_string.pdf}
    \caption{The magnetic string operator $S_m$ is defined by the open, oriented string $\tilde{\gamma}_{pp'}$, and creates a vortex (anti-vortex) a the red (blue) plaquette. \note{Owen: can you add a gray arrow orienting the string from red to blue. Change the label to $\tilde{\gamma}$. Maybe we should distinguish between the electric and magnetic charges in these two figures (maybe add a small e/m in the circles?}}
...
Additionally, topologically non-trivial string operators give rise to a topological degeneracy...
