...
Here we will review the string-net implementation of $Z_3$ gauge theory on the square lattice. We define a three -dimensional Hilbert space on each link, corresponding to the presence or absence of an oriented string segment that carries $Z_3$ electric flux which we represent graphically as
\begin{equation}
     \vvemptylink  \rightarrowlink \leftarrowlink
\end{equation}
