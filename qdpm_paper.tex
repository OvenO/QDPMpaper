...
&=\bigl\{ \left(\vrtplqt,\hrzplqt\right),\left(\vrtplqt,\hrzplqt\right),\left(\vrtplqt,\hrzplqt\right),\left(\vrtplqt,\hrzplqt\right) \bigr\}
\end{align}
...
%%%%%%%%%%%%%%%%%%%%%%%
   \begin{figure}[]
        \centering
        \includegraphics[width=0.75\columnwidth]{qdpm_dmr_HM_16x16.pdf}
        \caption{QDPM dimer structure factor $\gamma=0.5$.}
        \label{fig:spacial_z3vis_cor}
    \end{figure}
%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%
    \begin{figure}[]
        \centering
        \includegraphics[width=0.75\columnwidth]{qdpm_vis_HM_16x16.pdf}
        \caption{QDPM $Z_3$ vison structure factor $\gamma=0.5$.}
        \label{fig:spacial_z3vis_cor}
    \end{figure}
%%%%%%%%%%%%%%%%%%%%%%%
