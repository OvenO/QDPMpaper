...
\begin{equation}
S\left( \bm{q} \right) \equiv \frac{1}{ L^2} \sum_{i,j} e^{-i \bm{q} \cdot \left(\bm{r}_i - \bm{r}_j\right)} \left \langle n_i n_j \right \rangle
\end{equation}
where we restrict the sum to horizontal links.
