...
\begin{table}
    \begin{tabular}{| c | c | c | c | c | c |}
  	\hline
    $c_1$& $\bar{c}_1$ & $c_2$& $\bar{c}_2$ & $c_2$& $\bar{c}_2$ \\
	\hline
    $\pentmvcreate$& $\pentmvanal$ & $\penmvhrzleft$& $\penmvhrzright$ & $\penmvdiagup$& $\penmvdiagdown$ \\
	\hline
  \end{tabular}
...
\begin{figure}
    \centering
    \includegraphics[width=1.0\columnwidth]{spacial_cors.pdf}
